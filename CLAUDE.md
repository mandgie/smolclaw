...
```
smolclaw/              # Python package (~7000 lines, 14 modules)
...
├── channel.py         # Channel base + Telegram/Discord/Webhook + extensible registry (~710 lines)
...
- [x] Tests (1070+ tests, 98% coverage, pytest with mocked Claude SDK)
