...
| **Code size** | ~6700 lines | ~15K+ lines | ~25K+ lines | ~5K+ lines |
...
smolclaw install                     # Auto-start on login (macOS/Linux)
smolclaw completion bash|zsh|fish    # Generate shell completion script
...
```
smolclaw/              # Python package (~6400 lines)
